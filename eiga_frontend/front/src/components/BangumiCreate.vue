<template>
          ...
          <el-container>
            ...
            <el-main>
                ...
                <el-input v-model="bangumi_intro" :autosize="{ minRows: 2, maxRows: 20 }" type="textarea" placeholder="Please input" >
                </el-input>

                <el-divider border-style="dashed"/>角色
                ...
                <el-table :data="characterTable" style="width: auto" max-height="250">
                    ...
                    <el-table-column label="Operations" >
                        <template #default="scope">
                            <el-button link type="primary" size="small" @click.prevent="deleteCharacterRow(scope.$index)">Remove
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
                ...
                <el-row :gutter="20">
                    <el-col :span="24" >
                        <el-table :data="bangumiTable" style="width: auto" max-height="250">
                            ...
                            <el-table-column label="Operations" >
                                <template #default="scope">
                                    <el-button link type="primary" size="small" @click.prevent="deleteBangumiRow(scope.$index)">
                                        Remove
                                    </el-button>
                                </template>
                            </el-table-column>
    ...
    methods: {
      ...
      onAddCharacter() {
        if (this.characterObject) {
          ...
          this.characterTable.push({"character_id": this.characterObject.character_id, "character_name": this.characterObject.value})
        }
      },
      onAddBangumi() {
